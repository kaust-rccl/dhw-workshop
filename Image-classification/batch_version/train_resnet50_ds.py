...
def add_argument():
    ...
    parser.add_argument(
        "-D",
        "--data-dir",
        default="/ibex/reference/CV/tinyimagenet",
        type=str,
        help="Root directory where training, validation and test data will be found",
    )
    parser.add_argument(
        "-e",
        "--epochs",
...
def main(args):
   ...
   ########################################################################
    ...
    trainset = datasets.ImageFolder(os.path.join(args.data_dir,"train"),
    ...
    trainloader = torch.utils.data.DataLoader(trainset, 
                                           ...
                                           pin_memory=True)
        # Load or download cifar data.
    valset = datasets.ImageFolder(os.path.join(args.data_dir,"val"),
                         transform=transforms.Compose([
                             transforms.RandomResizedCrop(224),
                             transforms.RandomHorizontalFlip(),
                             transforms.ToTensor(),
