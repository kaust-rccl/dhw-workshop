...
cd ../testcase/3DFunky || { echo "Error: 'testcase/3DFunky' directory not found!"; exit 1; }
...
find . -maxdepth 1 -type d -regex './[1-9]+' -not -name '0.org' -exec rm -rf {} +  # Removes directories like 1, 2, ..., n but keeps 0.org
